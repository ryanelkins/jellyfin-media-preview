import type {
  ...
  PreviewBackdropMode,
  PreviewMode,
  PortraitCardCompressionMode,
  PortraitCardExpansionMode,
  PortraitCardExpansionLayoutMode,
  PreviewSource,
...
export const CONFIG_DEFAULTS = {
  ...
  PortraitCardExpansionLayoutMode: 'horizontal-only' as PortraitCardExpansionLayoutMode,
  PortraitCardCompressionMode: 'distance' as PortraitCardCompressionMode,
